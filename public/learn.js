...
const advanced = [
  ...
  ["Yield Curve", "2Y yield tracks Fed expectations. 10Y yield tracks growth, inflation, and term premium. NAS100 reacts heavily to both."],
  ["Liquidity", "When liquidity is loose, BTC and NAS100 can rise even with mixed data. When liquidity tightens, risk assets struggle."],
  ["Risk Regime", "Risk-on favors BTC/NAS100. Risk-off favors USD, JPY, sometimes Gold if fear is stronger than yields."],
...
const drivers = [
  ["Fed Speeches", "Fed speakers can move the market between major news events. Hawkish tone supports yields and USD. Dovish tone can support Gold and NAS100."],
  ...
  ["Treasury Auctions", "Weak auctions can push yields higher because investors demand more return to hold US debt. That can pressure Gold and NAS100."],
...
const terms = [
  ...
  ["US10Y", "The US 10-year Treasury yield, important for Gold and NAS100."],
  ...
  ["Risk-on", "Market mood where traders buy growth assets like NAS100 and BTC."],
  ...
  ["Equities", "Stocks like NAS100 and US30."],
...
const conflicts = [
  "Strong NFP + soft CPI: growth is strong but inflation is cooling. Wait for yields. If yields fall, Gold/NAS100 can rally.",
  "Weak NFP + hot CPI: stagflation risk. USD can be choppy, Gold can get safe-haven support, NAS100 can struggle.",
...
const tutorial = [
  ...
  ["3. Build both scenarios", "Write the hot-data and soft-data scenario before the release. Example: hot CPI means yields up, USD up, Gold/NAS100 pressure."],
...
const examples = [
  "Hot CPI: Fed reprices hawkish, yields rise, USD strengthens, Gold and NAS100 usually drop.",
  "Soft CPI: yields fall, USD weakens, Gold and NAS100 can rally if risk sentiment holds.",
  ...
  "Yields rise and NAS100 rises too: risk appetite may be overpowering rates; reduce confidence."
];
...
const quiz = [
  ...
  ["Why can NAS100 drop after hot CPI?", "Higher rates compress tech valuations."],
